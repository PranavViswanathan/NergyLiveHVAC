        ...
        if not queue.empty():
            ...
            try:
                if is_valid_url(url=config.READ_BACNET_DATA_URL):
                    ...
                    headers = {"Content-Type": "application/json", 'Authorization': 'Bearer YOUR_API_KEY_OR_TOKEN',}
...
# Or use json=data directly
                    ...
                    request.add_headers('User-Agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:106.0) Gecko/20100101 Firefox/106.0')
